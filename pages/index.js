  ...
  return (
    <><>
      ...
      <div className="relative bg-cover bg-center bg-no-repeat py-8" style={{ backgroundImage: "url(/assets/img/bg-hero.jpg)" }}>
        <div
          className="absolute inset-0 z-20 bg-gradient-to-r from-hero-gradient-from to-hero-gradient-to bg-cover bg-center bg-no-repeat opacity-20">
        </div>
            ...
            <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              ...
              <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                ...
                <Link href={'/blogs'}><div className="buttons text-center md:text-left">
                  <button className='bg-green-600 text-white border-2 px-4 py-1 my-4 rounded-2xl'>All Blogs</button>
                </div></Link>
            </div>
          </div>
        </div>
          ...
          <div className="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
            ...
            <div className="pt-6">
              <div className="flex items-end justify-between">
                ...
                <h3 className="font-body text-3xl font-bold text-primary">78%</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{"width": "78%"}}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
               Create Complete Website with Modern FrameWorks
              </p>
            </div>
          </div>
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                Include writing Blogs Posts, Reports Etc.
              </p>
            </div>
          </div>
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                I Create Visualistic Web Designs With Animations and Graphics
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container py-16 md:py-20" id="contact">
        ...
        <form   onSubmit={function gotowhatsapp1() {
    var name = document.getElementById("name").value;
    var email = document.getElementById("email").value;
    var message = document.getElementById("message").value;
        var url =
          "https://wa.me/923104416475?text=" +
          "Name : " +
          name +
          "%0a" +
          "Email: " +
          ...
          "Message : " +
         message;
        window.open(url, "_blank").focus();}} method="post" className="mx-auto w-full pt-10 sm:w-3/4">
          <div className="flex flex-col md:flex-row">
            <input required className="mr-3 w-full rounded border-grey-50 px-4 py-3 font-body text-black md:w-1/2 lg:mr-5"
